...
VALUES
	...
	('0a82c892-9ac6-4929-86ea-08fa11e50be3', 'admin', 'admin', 'admin', 0, 'admin.admin@mail.ru', 'asdfa', 'asdf'),
	('2803991e-264f-47dd-9614-b4909291e7cc', 'user', 'user', 'user', 0, 'user.user@mail.ru', 'asdfa', 'asdf');
