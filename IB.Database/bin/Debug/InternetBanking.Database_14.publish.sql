...
CREATE TABLE [dbo].[BankCard] (
    ...
    [VerificationCode] NVARCHAR (1)     NOT NULL,
    [PinCode]          NVARCHAR (1)     NOT NULL,
...
INSERT INTO [dbo].[BankAccount] (Id, UserId, Number, EndDate, Active)
VALUES
	('5db58cf4-d54c-4341-bfe9-446fb09581b5', '2803991e-264f-47dd-9614-b4909291e7cc', 543268975346875437, '20190701', 1)
...
VALUES
	('0920ec93-794b-4f4c-85ac-8551f05cb47b', '2803991e-264f-47dd-9614-b4909291e7cc', '5db58cf4-d54c-4341-bfe9-446fb09581b5', 
			4325623457850856, '칮핏섛鐓鈦絣䮝\u0e86', '귾⸅�ㇻ鯄酪�⓭', '20190601', 1)
